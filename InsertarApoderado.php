...
<form name="modifica" method="mno" action="InsertarDatosApoderado.php" >
		<table align="center">
     ...
     <tr>
 			 ...
 			 <td><input type="txt"name="ocupacion"size="25"value="" onkeyup="javascript:this.value=this.value.toUpperCase();"/></td>
 		 </tr>
     <tr>
