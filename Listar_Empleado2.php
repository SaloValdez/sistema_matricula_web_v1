                 ...
                 <div class="box">
                   ...
                   <div class="box-body">
                     	<div class="row">
   	                  	<div class="col-md-12">
   		                          <!--Contenido-->
                                <center> <h3>Realizar mantenimineto  datos empleado</h3></center>
                                 <a href="InsertarEmpleado.php"><input class="btn_insertar" type="submit" value="Insertar"/></a>
                                <p></p>

                                 <?php
                               	require('a_conexion2.php');
                               	$query="SELECT idEmpleado,apeEmpleado,nomEnmpleado,dirEmpleado,telEmpleado,carEmpleado FROM empleado";
                                      ...
                                      <td class="cabecera">ID</td>
                                       ...
                                       <tbody>
                                         ...
                                         <td><?php echo $row['idEmpleado'];?></td>
                                           <td><?php echo $row['apeEmpleado'];?></td>
                                           <td><?php echo $row['nomEnmpleado'];?></td>
                                           <td><?php echo $row['dirEmpleado'];?></td>
                                           <td><?php echo $row['telEmpleado'];?></td>
                                             <td><?php echo $row['carEmpleado'];?></td>
                               			      <td ><a href="modificarDatosEmpleado.php?id=<?php echo $row['idEmpleado'];?>" class="enlaceboton">Modificar</a></td>
                               	         <td><a href="EliminarEmpleado.php?id=<?php echo $row['idEmpleado'];?>" class="enlaceboton1">Eliminar</a></td>
                                         </tr>
                                       </tbody>
