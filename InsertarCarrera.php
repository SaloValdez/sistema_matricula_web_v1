...
<form name="modifica" method="POST" action="InsertarDatosCarrera.php" >
		<table align="center">

      
		<tr>
			 <td height="52"><b>NUEVA CARRERA:</b></td>
			 <td><input type="txt"name="carrera"size="25"value="" onkeyup="javascript:this.value=this.value.toUpperCase();"/></td>
		 </tr>
	 <tr>
		 <tr>
