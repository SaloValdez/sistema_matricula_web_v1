...
<form name="modifica" method="POST" action="InsertarDatosAlumno.php" >
		<table align="center">

			<tr>
				<td height="60"><b>APODERADO</b></div></td>
		 <td><input type="txt" name="apoderado"size="25"value="" onkeyup="javascript:this.value=this.value.toUpperCase();"/></td>
			</tr>
		<tr>
     ...
     <tr>
      ...
      <tr>
        <td height="52"><b>FECH. NACIMIENTO</b></td>
      ...
      <tr>
        ...
        <td><input type="txt"name="genero"size="25"value="" onkeyup="javascript:this.value=this.value.toUpperCase();"/></td>
      </tr>
      <tr>
